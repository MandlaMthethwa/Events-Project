...
<body>
    ...
    <li>
        @Html.ActionLink("Upadate your password " + "!", "ChangePassword", "Manage", New With {.id = 1}, New With {.style = "color:white;", .Class = "navbar-left"})
    </li>

    <li>@Html.ActionLink(" View Events", "Index", "Eventts")</li>
    <li>@Html.ActionLink(" View Your Participants", "Index", "Users")</li>
    <li>
        @Html.ActionLink("Welcome " + User.Identity.GetUserName(), "Index", "Home", New With {.area = ""}, New With {.style = "color:white;", .Class = "navbar-right"})
    </li>
